...
// Stop a Timer, Process Results, go to Score Page
function checkTime() {
  console.log(timePLayed);  
  if (playerGuessArray.length == questionAmount) {
    console.log('player guess array:', playerGuessArray);
    clearInterval(timer);
    // Check for wrong guesses, andd penalty time
...
// Add a tenth of a scond to timePlayed
function addTime() {
  timePLayed += 0.1;
  checkTime();
}
...
// Show the Actual Countdown 3, 2, 1, GO!
